...
nodesset = get_boundary_points(grid, getnodeset(grid, "traction"))

scatter!(ax2, facesset, color=:blue,markersize=15.0, marker=:circle, label = "Fixed XYZ")
scatter!(ax2, nodesset, color=:red,markersize=15.0, marker=:circle, label = "Traction")
